            ...
            <Container className={estilo.container}>
                <Row>
                    <Col xs={12} md={4} className={estilo.centro}>
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nulla est sed pariatur aliquid nobis ipsa sapiente iste repudiandae ad reprehenderit. Doloremque dolor earum doloribus nulla temporibus, eius inventore consectetur molestiae!</p>
                    </Col>
                    <Col xs={12} md={4} className={estilo.centro}>
